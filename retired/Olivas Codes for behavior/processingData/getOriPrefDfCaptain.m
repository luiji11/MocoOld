function mice = getOriPrefDfCaptain(split)
...
for i = 1:nMice    
    ...
    nvH = mice(i).naive.H.df(30:end,:,:);
    nvM = mice(i).naive.M.df(30:end,:,:);
    nvC = mice(i).naive.CR.df(30:end,:,:) ;   
    nvF = mice(i).naive.FA.df(30:end,:,:);
    
    % Get Expert Selectivity
    exH = mice(i).expert.H.df(30:end,:,:);
    exM = mice(i).expert.M.df(30:end,:,:);
    exC = mice(i).expert.CR.df(30:end,:,:);   
    exF = mice(i).expert.FA.df(30:end,:,:);
